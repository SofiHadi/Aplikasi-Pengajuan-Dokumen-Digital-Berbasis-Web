...
if (isset($_GET['search'])) {
    ...
    $query_select = "SELECT * FROM dokumen WHERE nama_dokumen LIKE '%$search%' OR deskripsi LIKE '%$search%' ORDER BY id DESC";
} else {
    $query_select = "SELECT * FROM dokumen ORDER BY id DESC";
}
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom py-3">
        <div class="container">
            ...
            <div class="ms-auto d-flex align-items-center gap-3">
                <span class="text-secondary small">Halo, <strong class="text-success"><?= $_SESSION['username']; ?></strong></span>
    ...
    <div class="container my-4">
        <div class="card server-status-card p-4 mb-4 shadow-sm">
            <h4 class="fw-bold mb-1">Status Server Berjalan</h4>
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody class="small">
                        ...
                        <?php if(mysqli_num_rows($data_dokumen) == 0): ?>
                            <tr><td colspan="4" class="text-center text-muted py-4">Tidak ada data berkas masuk.</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
